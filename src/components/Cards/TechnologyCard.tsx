    ...
    return (
        <div>
            ...
            <div className='flex flex-col items-center justify-center  mt-5 p-5 space-y-5 bg-gradient-to-b from-[#1e1629] to-[#04061d] rounded-lg shadow-2xl'>
                ...
                <div className='sm:flex-col md:grid grid-cols-8 p-2 '>
                    {KnownTechnologies.map((tech, index) => (
                        <div key={index} className='flex items-center hover:scale-110 duration-150 justify-center mx-1 my-1 w-16 h-16 bg-gray-800 rounded-full'>
                            <Tooltip text={tech.name}>
                                <Image src={tech.image} className='rounded-full pt-2' alt='' width={50} height={50} />
                            </Tooltip>
                ...
                <div>
                    ...
                    <div className='sm:flex-col md:grid grid-cols-7 space-x-1 mt-2 '>
                        {FutureTechnologies.map((tech, index) => (
                            <div key={index} className='flex items-center hover:scale-110 duration-150  justify-center mx-1 my-1 w-16 h-16 bg-gray-800 rounded-full'>
                                <Tooltip text={tech.name}>
                                    <Image src={tech.image} className='rounded-full mt-2' alt='' width={50} height={50} />
                                </Tooltip>
