    ...
    return (
        <div>
            <div className={`box-border w-80 h-auto ml-5 shadow-xl ${animate ? "animate-pulse" : ""}`}>
                <div className='flex flex-col  mt-5 items-center  rounded-2xl justify-center w-full h-full hover:scale-105 duration-150 bg-gradient-to-b from-[#1e1629] to-[#04061d]'>
